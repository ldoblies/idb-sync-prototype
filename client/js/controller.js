...
(function (window) {
    ...
    var _self = this;
      ...
      _self.$todoItemCounter.innerHTML = _self.view.itemCounter(todos.active);

      _self.$clearCompleted.innerHTML = _self.view.clearCompletedButton(todos.completed);
      _self.$clearCompleted.style.display = todos.completed > 0 ? 'block' : 'none';

      _self.$toggleAll.checked = todos.completed === todos.total;

      _self._toggleFrame(todos);
    });
	};
