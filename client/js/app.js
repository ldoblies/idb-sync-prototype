...
(function () {
	...
	function Todo(name) {
    var _self = this;
		this.storage = new app.Store(name, function(result){
      _self.controller._updateFilterState();
      _self.controller.showAll();
    });
    ...
    this.updateView = function(){
      this.controller._filter(true);
    };
	}

	var todo = window.app.todo = new Todo('todos');
